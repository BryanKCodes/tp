...
public class Stats {
    ...
    public static final String MESSAGE_CONSTRAINTS =
            "Creeps score per minute (cpm) must be an integer between 0 and 40;\n"
                    + "Gold difference at 15m (gd15) must be a decimal between -10,000 and 10,000;\n"
                    + "Kill/Death/Assist (kda) must be a decimal between 0.0 and 200.0";
